                ...
                <form action="{{ route('user.store') }}"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name='start_time' class="form-control" id="start_time" aria-describedby="emailHelp"  placeholder="Enter Start time" required maxlength="2" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            @error('start_time')
                                <div class="alert alert-danger p-0 my-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="end_time" aria-describedby="emailHelp" name="end_time" placeholder="Enter End Time" required maxlength="2" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            @error('end_time')
                                <div class="alert alert-danger p-0 my-2">{{ $message }}</div>
                            @enderror
                        </div>
